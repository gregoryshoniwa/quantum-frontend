        ...
        methods: {
            ...
            async loadGraphDataBuyDate(dataTime,currSymbol){
                 ...
                 //console.log(currSymbol)
                    await Axios.post(this.nodeApi+'/getSalesByDateGraphCurr2',{currency_id:currSymbol,time:dataTime},{headers:headers})
                    .subscribe(res =>{
             ...
             async loadGraphDataBuyDateSpecific(start_date,end_date,currSymbol){
                 let headers = {            
                    ...
                    // console.log(headers)
                    await Axios.post(this.nodeApi+'/getSalesByDateGraphSpecificCurr',{currency_id:currSymbol,start_date:start_date,end_date:end_date},{headers:headers})
                    .subscribe(res =>{
                         this.rawData = res.data.data.one.recordset
                        this.rawData2 = res.data.data.two.recordset
                     ...
                     if(sells.length > 0){
                         if(element.date_t == sells[counter].date_t){
                              ...
                              date2.push(sells[counter].day_name)
                               data2.push(parseFloat(sells[counter].disbure_amount).toFixed(2))
