    ...
    <v-layout row wrap>
      <v-flex xs12 sm12 md12 lg12 xl6 pa-2>
        <v-flex>
           <v-layout row wrap>
             <v-flex mr-3 mt-3>
            <h3>Branch Volume + Commission</h3>
            </v-flex>
           </v-layout>
          <v-card hover>
              
            <BookingChart3 :ToggleCurrency="toggleCurr" class="echart" />
          </v-card>
        </v-flex>
      </v-flex>
      ...
      <v-flex xs12 sm12 md12 lg12 xl6 pa-2>
        <v-flex>
          ...
          <v-card hover>
            <MarketRates3ConiSend :TimePeriod="timeP" :ToggleCurrency="toggleCurr" class="echart2" />
          </v-card>
        </v-flex>
      </v-flex>
      ...
      <v-flex xs12 sm12 md12 lg12 xl6 pa-2>
        <v-flex>
          ...
          <v-card hover>
            <MarketRates4ContiSend :TimePeriod="timeS" :ToggleCurrency="toggleCurr" class="echart2" />
          </v-card>
        </v-flex>
      </v-flex>
...
<script>
  import BookingChart3 from '@/components/BookingChart3'
  import MarketRates3 from '@/components/MarketRates3'
  import MarketRates3ConiSend from '@/components/MarketRates3ConiSend'
  import MarketRates4 from '@/components/MarketRates4'
  import MarketRates4ContiSend from '@/components/MarketRates4ContiSend'
  ...
  export default {
    components: {
      BookingChart3,
      MarketRates3,
      MarketRates3ConiSend,
      MarketRates4,
      MarketRates4ContiSend,
      SuperGraph11,
      SuperGraph22
    },
    data() {
