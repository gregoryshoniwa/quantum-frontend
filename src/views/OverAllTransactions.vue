<template>
  <div>
    <v-layout row justify-end>
      <h2 style="color: grey">Full Over-all Transaction Report</h2>
    </v-layout>
          ...
          <v-flex mb-2 class="card cardRev3">
            <v-layout ma-1>
              ...
              <v-flex style="text-align: right; padding: 3px">
                ...
                <h3 style="color: red">
                  {{ item.disbursed_currencyT }}
                  {{ parseFloat(item.disburse_amountT).toFixed(2) }}
                </h3>
              </v-flex>
            </v-layout>
          </v-flex>
    ...
    <v-layout row wrap justify-end>
      ...
      <v-flex xs12 sm6 md3 mt-2>
        <v-btn-toggle mandatory v-model="toggle" color="primary">
          ...
          <v-btn flat value="4"> Reversals </v-btn>
        </v-btn-toggle>
      </v-flex>
        ...
        >
          <template v-slot:items="props">
            <tr>
              ...
              <td v-show="toggle !== `3`">{{ props.item.name }}</td>
              <td>
                <v-chip
                  label
                  color="red"
              ...
              <td id="chip-usage-example">
                <v-chip
                  ...
                  color="red"
                  text-color="white"
                  v-if="props.item.status.replace(/\s/g, '') == 'canceled'"
                >
                  {{ props.item.status }}
                </v-chip>
                <v-chip
                  label
                  color="gray"
                  v-if="props.item.status.replace(/\s/g, '') == 'pending'"
                >
                  {{ props.item.status }}
                </v-chip>
                ...
                <v-chip
                  ...
                  color="red"
                  text-color="white"
                  v-if="props.item.status.replace(/\s/g, '') == 'declined'"
                >
                  declined
                </v-chip>
                <v-chip
                  ...
                  color="red"
                  text-color="white"
                  v-if="props.item.status.replace(/\s/g, '') == 'reversed'"
                >
                  reversed
                </v-chip>
                <v-chip
                  ...
                  color="blue"
                  text-color="white"
                  v-if="props.item.status.replace(/\s/g, '') == 'complete'"
                >
                  {{ props.item.status }}
                </v-chip>
                <v-chip
                  pill
                  color="gray"
                  v-if="props.item.status.replace(/\s/g, '') == 'confirmed'"
                >
                ...
                <v-chip
                  pill
                  color="gray"
                  v-if="props.item.status.replace(/\s/g, '') == 'GM'"
                >
                ...
                <v-chip
                  pill
                  color="gray"
                  v-if="props.item.status.replace(/\s/g, '') == 'TR'"
                >
                  <v-icon left color="red">person_pin</v-icon>
                  Treasury
                </v-chip>
              ...
              <td>
                <v-tooltip
                  bottom
                  v-if="
                    (props.item.status.replace(/\s/g, '') == 'complete' &&
                      props.item.transaction_type.replace(/\s/g, '') == 'Sell') ||
                    (props.item.status.replace(/\s/g, '') == 'complete' &&
                      props.item.transaction_type.replace(/\s/g, '') == 'Buy')
                  "
                >
                  <template v-slot:activator="{ on }">
                    <v-btn small color="success" icon @click="Reverse(props.item)">
                      <v-icon v-on="on" medium class="white--text"> cached </v-icon>
                    </v-btn>
                  </template>
  ...
  methods: {
    ...
    async daterange() {
      ...
      if (this.toggle == "1" && this.toggleDates == "2") {
        ...
        await Axios.post(
          this.nodeApi + "/getAllTransactionsSpecific",
        ...
        await Axios.post(
          this.nodeApi + "/getAllTransactionsSumSpecific",
          { start: this.start_date, end: this.end_date },
          { headers: headers }
        ).subscribe(
          (res) => {
      ...
      if (this.toggle == "2" && this.toggleDates == "2" && this.branch_id != null) {
        ...
        await Axios.post(
          this.nodeApi + "/getAllBranchTransactionsSpecific",
        ...
        await Axios.post(
          this.nodeApi + "/getAllBranchTransactionsSumSpecific",
          { start: this.start_date, end: this.end_date, branch_id: this.branch_id },
          { headers: headers }
        ).subscribe(
          (res) => {
      ...
      if (this.toggle == "3" && this.toggleDates == "2" && this.user_id != null) {
        ...
        await Axios.post(
          this.nodeApi + "/getAllTellerTransactionsSpecific",
        ...
        await Axios.post(
          this.nodeApi + "/getAllTellerTransactionsSumSpecific",
          { start: this.start_date, end: this.end_date, user_id: this.user_id },
          { headers: headers }
        ).subscribe(
          (res) => {
    ...
    async getAllTransactions() {
      ...
      await Axios.get(this.nodeApi + "/getAllTransactionsNow", {
        headers: headers,
      }).subscribe(
        (res) => {
          this.rows = res.data.data.one.recordset;
      ...
      await Axios.get(this.nodeApi + "/getAllTransactionsSumNow", {
        headers: headers,
      }).subscribe(
        (res) => {
          this.tranTotals = res.data.data.one.recordset;
    ...
    async getAllTransactionsByID(data) {
      ...
      await Axios.post(
        this.nodeApi + "/getAllTransactionsByID",
    ...
    async getAllTransactionsMonthNow() {
      ...
      await Axios.get(this.nodeApi + "/getAllTransactionsMonthNow", {
        headers: headers,
      }).subscribe(
        (res) => {
          this.rows = res.data.data.one.recordset;
      ...
      await Axios.get(this.nodeApi + "/getAllTransactionsSumNowMonth", {
        headers: headers,
      }).subscribe(
        (res) => {
          this.tranTotals = res.data.data.one.recordset;
    ...
    async getAllBranchTransactions(data) {
      ...
      await Axios.post(
        this.nodeApi + "/getAllBranchTransactions",
        { branch_id: data },
        { headers: headers }
      ).subscribe(
        (res) => {
    ...
    async getAllBranchTransactionsNowByID(data) {
      ...
      await Axios.post(
        this.nodeApi + "/getAllBranchTransactionsNowByID",
        { branch_id: data },
        { headers: headers }
      ).subscribe(
        (res) => {
    ...
    async getAllBranchTransactionsNow(data) {
      ...
      await Axios.post(
        this.nodeApi + "/getAllBranchTransactionsNow",
        { branch_id: data },
        { headers: headers }
      ).subscribe(
        (res) => {
    ...
    async getAllBranchTransactionsMonthNow(data) {
      ...
      await Axios.get(this.nodeApi + "/getAllBranchTransactionsMonthNow", {
        headers: headers,
      }).subscribe(
        (res) => {
          this.rows = res.data.data.one.recordset;
    ...
    async getAllBranchTransactionsMonthNowByID(data) {
      ...
      await Axios.post(
        this.nodeApi + "/getAllBranchTransactionsMonthNowByID",
        { branch_id: data },
        { headers: headers }
      ).subscribe(
        (res) => {
    ...
    async getAllTellerTransactions(data) {
      ...
      await Axios.post(
        this.nodeApi + "/getAllTellerTransactions",
        { user_id: data },
        { headers: headers }
      ).subscribe(
        (res) => {
    ...
    async getAllTellerTransactionsNowByID(data) {
      ...
      await Axios.post(
        this.nodeApi + "/getAllTellerTransactionsNowByID",
        { user_id: data },
        { headers: headers }
      ).subscribe(
        (res) => {
    ...
    async getAllTellerTransactionsMonthNowByID(data) {
      ...
      await Axios.post(
        this.nodeApi + "/getAllTellerTransactionsMonthNowByID",
        { user_id: data },
        { headers: headers }
      ).subscribe(
        (res) => {
    ...
    async getAllBranchTransactionsSum(data) {
      ...
      await Axios.post(
        this.nodeApi + "/getAllBranchTransactionsSum",
        { branch_id: data },
        { headers: headers }
      ).subscribe(
        (res) => {
    ...
    async getAllBranchTransactionsSumNow(data) {
      ...
      await Axios.post(
        this.nodeApi + "/getAllBranchTransactionsSumNow",
        { branch_id: data },
        { headers: headers }
      ).subscribe(
        (res) => {
    ...
    async getAllBranchTransactionsSumNowByID(data) {
      ...
      await Axios.post(
        this.nodeApi + "/getAllBranchTransactionsSumNowByID",
        { branch_id: data },
        { headers: headers }
      ).subscribe(
        (res) => {
    ...
    async getAllBranchTransactionsSumMonthNow(data) {
      ...
      await Axios.post(
        this.nodeApi + "/getAllBranchTransactionsSumMonthNow",
        { branch_id: data },
        { headers: headers }
      ).subscribe(
        (res) => {
    ...
    async getAllTellerTransactionsSum(data) {
      ...
      await Axios.post(
        this.nodeApi + "/getAllTellerTransactionsSum",
        { user_id: data },
        { headers: headers }
      ).subscribe(
        (res) => {
    ...
    async getAllTellerTransactionsSumNow(data) {
      ...
      await Axios.post(
        this.nodeApi + "/getAllTellerTransactionsSumNow",
        { user_id: data },
        { headers: headers }
      ).subscribe(
        (res) => {
    ...
    async getAllTellerTransactionsSumMonthNow(data) {
      ...
      await Axios.post(
        this.nodeApi + "/getAllTellerTransactionsSumMonthNow",
        { user_id: data },
        { headers: headers }
      ).subscribe(
        (res) => {
