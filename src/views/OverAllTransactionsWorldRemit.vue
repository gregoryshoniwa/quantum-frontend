<template>
  <div>
   ...
   <v-layout row justify-end>
     ...
     <h2 style="color:green;">Full Over-all World Remit Report</h2>
            ...
            >
                ...
                <template v-slot:items="props">
                    <tr>                   
                        ...
                        <td >{{new Date(JSON.parse(props.item.transactionData).wrtDateCreated).toLocaleString('en-GB') }}</td>
                        ...
                        <td >{{JSON.parse(props.item.recipiantData).mobilePhone }} </td>
  ...
  export default {
    ...
    data: () => ({
      ...
      //Excel data
        ...
        json_fields: {
          ...
          'Pay Out Currency' :'clientCurrency',
          'Pay Out Amount' :'payOut',
          'FX Rate Applied' : 'fxRate',
          ...
          'Name of Sender':'sentBy',
          'Name of Beneficiary':'clientName',
          ...
          'Beneficiary Identity Number':{
                ...
                callback: (value) => {
                  if(value){
                    try {
                        var newObject = JSON.parse(value.replace(/\s/g, ''));
                   
                        return `${newObject.clientID}`;
          ...
          'Beneficiary Gender (M/F)' :{
                field: 'additionalInfo',
                callback: (value) => {
                   if(value){
                  //   var newObject = JSON.parse(value.replace(/\s/g, ''));
                  //  return `${newObject.clientGender}`;

                    try {
                        var newObject = JSON.parse(value.replace(/\s/g, ''));
                   
                        return `${newObject.clientGender[0]}`;
          ...
          'Physical Address' :{
                ...
                callback: (value) => {
                  if(value){
                  //   var newObject = JSON.parse(value.replace(/\s/g, ''));
                  // return `${newObject.clientAddress}`;
          ...
          'Beneficiary District' :{
                ...
                callback: (value) => {
                  if(value){
                  //   var newObject = JSON.parse(value.replace(/\s/g, ''));
                  // return `${newObject.clientDistrict}`;
          ...
          'Source Country Code' : {
           ...
           'Transaction Purpose Code':{
                ...
                callback: (value) => {
                   if(value){
                  //   var newObject = JSON.parse(value.replace(/\s/g, ''));
                  // return `${newObject.transactionPurpose}`;
           ...
           'Currency Code':'clientCurrency',
           'Amount':'payOut',
           'Mode of Payout (Cash/Account)':'transactionType',
              ...
              field: 'createdAt',
                callback: (value) => {
                  ...
                  // return `${newObject.sourceFunds}`;
                   ...
                   try {
                        var newObject = new Date(value).toLocaleString('en-GB');
         ...
         json_fields_rbz3: {
              ...
              field: 'createdAt',
                callback: (value) => {
                  ...
                  // return `${newObject.sourceFunds}`;
                   ...
                   try {
                        var newObject = new Date(value).toLocaleDateString('en-GB');
              ...
              field: 'createdAt',
                callback: (value) => {
                  ...
                  // return `${newObject.sourceFunds}`;
                   ...
                   try {
                        var newObject = new Date(value).toLocaleTimeString('en-GB');
          ...
          'Payout CCY':'clientCurrency', 
          
               
        
         'Transaction commission' :'commission',
             'Transaction commission CCY' :'sentCurrency'
            }, 
        json_title: [
            'CONTICASH - WORLD REMIT TRANSACTION REPORT','Daily Reporting Template',' '
        ],
        json_title_rbz: [
            'EC-FORM-ADLA(I) ',' ',`INSTITUTION CODE: 0015000`,`FINANCIAL YEAR: ${new Date(Date.now()).getFullYear()}`,`START DATE: ${new Date(Date.now()).getDate()}/${new Date(Date.now()).getMonth()+1}/${new Date(Date.now()).getFullYear()}`,`END DATE: ${new Date(Date.now()).getDate()}/${new Date(Date.now()).getMonth()+1}/${new Date(Date.now()).getFullYear()}`,' '
        ],
        json_data: [
    ...
    methods: {
     ...
     async getAllTransactions(){
        ...
        await   Axios.get(this.nodeApi+'/getAllTransactionsNowUtilWorldRemit',{headers:headers})
          .subscribe(res =>{
            this.rows = res.data.data.one.recordset
            // console.log( this.rows)
          },err => console.log(err)) 

         await  Axios.get(this.nodeApi+'/getAllTransactionsSumNowUtilWorldRemit',{headers:headers})
          .subscribe(res =>{
            this.tranTotals = res.data.data.one.recordset
            //this.dialogdaterange = false
            //console.log(this.companyData)
     ...
     async getAllTransactionsNow(){
      ...
      //   console.log(this.transactionID)
        let headers = {            
         ...
         await  Axios.post(this.nodeApi+'/getAllTransactionsByIDWorldRemit',{tran_id:this.transactionID},{headers:headers})
          .subscribe(res =>{
            this.rows = res.data.data.one.recordset
            //console.log(this.companyData)
          },err => console.log(err)) 
     ...
     async getAllTransactionsMonthNow(){
        ...
        await  Axios.get(this.nodeApi+'/getAllTransactionsMonthNowUtilWorldRemit',{headers:headers})
          .subscribe(res =>{
            this.rows = res.data.data.one.recordset
            //console.log(this.companyData)
          },err => console.log(err)) 

           await  Axios.get(this.nodeApi+'/getAllTransactionsSumNowUtilWorldRemitMonth',{headers:headers})
          .subscribe(res =>{
            this.tranTotals = res.data.data.one.recordset
            //this.dialogdaterange = false
            //console.log(this.companyData)
    ...
    async  getAllBranchTransactions(data){
      ...
      async  getAllBranchTransactionsNowByID(data){
        let headers = {            
         ...
         await  Axios.post(this.nodeApi+'/getAllBranchTransactionsNowByIDUtilWorldRemit',{branch_id:data},{headers:headers})
          .subscribe(res =>{
            this.rows = res.data.data.one.recordset
            //console.log(this.companyData)
          },err => console.log(err)) 
      ...
      async  getAllBranchTransactionsMonthNow(data){
       ...
       async  getAllBranchTransactionsMonthNowByID(data){
        let headers = {            
         ...
         await  Axios.post(this.nodeApi+'/getAllBranchTransactionsMonthNowByIDUtilWorldRemit',{branch_id:data},{headers:headers})
          .subscribe(res =>{
            this.rows = res.data.data.one.recordset
            //console.log(this.companyData)
          },err => console.log(err)) 
    ...
    async  getAllTellerTransactions(data){
      ...
      async  getAllTellerTransactionsNowByID(data){
        let headers = {            
         ...
         await  Axios.post(this.nodeApi+'/getAllTellerTransactionsNowByIDUtilWorldRemit',{user_id:data},{headers:headers})
          .subscribe(res =>{
            this.rows = res.data.data.one.recordset
            //console.log(this.companyData)
          },err => console.log(err)) 
      ...
      async  getAllTellerTransactionsMonthNowByID(data){
        let headers = {            
         ...
         await  Axios.post(this.nodeApi+'/getAllTellerTransactionsMonthNowByIDUtilWorldRemit',{user_id:data},{headers:headers})
          .subscribe(res =>{
            this.rows = res.data.data.one.recordset
            //console.log(this.companyData)
          },err => console.log(err)) 
    ...
    async  getAllBranchTransactionsSum(data){
       ...
       async  getAllBranchTransactionsSumNow(data){
        ...
        await   Axios.post(this.nodeApi+'/getAllBranchTransactionsSumNowUtilWorldRemit',{branch_id:data},{headers:headers})
          .subscribe(res =>{
            this.tranTotals = res.data.data.one.recordset
      ...
      async  getAllBranchTransactionsNowByIDSpec(data){
        let headers = {            
         ...
         await  Axios.post(this.nodeApi+'/getAllBranchTransactionsNowByIDUtilWorldRemitSpec',{branch_id:data,start_date:this.start_date,end_date:this.end_date},{headers:headers})
          .subscribe(res =>{
            this.rows = res.data.data.one.recordset
            //console.log(this.companyData)
          },err => console.log(err)) 
      ...
      async  getAllBranchTransactionsSumNowSpec(data){
        ...
        await   Axios.post(this.nodeApi+'/getAllBranchTransactionsSumNowUtilWorldRemitSpec',{branch_id:data,start_date:this.start_date,end_date:this.end_date},{headers:headers})
          .subscribe(res =>{
            this.tranTotals = res.data.data.one.recordset
      ...
      async  getAllBranchTransactionsSumNowByID(data){
       ...
       async  getAllBranchTransactionsSumMonthNow(data){
        ...
        await   Axios.post(this.nodeApi+'/getAllBranchTransactionsSumMonthNowUtilWorldRemit',{branch_id:data},{headers:headers})
          .subscribe(res =>{
            this.tranTotals = res.data.data.one.recordset
    ...
    async  getAllTellerTransactionsSum(data){
      ...
      async  getAllTellerTransactionsSumNow(data){
        ...
        await   Axios.post(this.nodeApi+'/getAllTellerTransactionsSumNowUtilWorldRemit',{user_id:data},{headers:headers})
          .subscribe(res =>{
            this.tranTotals = res.data.data.one.recordset
            //console.log(this.companyData)
          },err => console.log(err)) 
      ...
      async  getAllTellerTransactionsSumMonthNow(data){
        ...
        await   Axios.post(this.nodeApi+'/getAllTellerTransactionsSumMonthNowUtilWorldRemit',{user_id:data},{headers:headers})
          .subscribe(res =>{
            this.tranTotals = res.data.data.one.recordset
            //console.log(this.companyData)
          },err => console.log(err)) 
